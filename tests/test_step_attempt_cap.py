...
def test_the_auth_block_says_how_to_actually_fix_it(tmp_path, monkeypatch):
    ...
    # Gives ONE command that does the whole thing (harn picks the right
    # per-agent login itself), and says the subprocess needs its OWN login —
